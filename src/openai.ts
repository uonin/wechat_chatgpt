 ...
 * @param message
 */
async function chatgpt(username:string,message: string): Promise<string> {console.log("请求出错2");
  // 先将用户输入的消息添加到数据库中
 ...
 * @param prompt
 */
async function dalle(username:string,prompt: string) { console.log("请求出错3");
 ...
 * @param videoPath
 */
async function whisper(username:string,videoPath: string): Promise<string> { console.log("请求出错4");
